...
; Show the desktop
Action_TopLeft() {
    ; Aero 3D task switcher
    ;Send, {LWin down}{Ctrl down}{Tab down}
    ;Send, {LWin up}{Ctrl up}{Tab up}
}
; Minimize all windows
Action_BottomRight() {
    ; minimize all windows
    Send, {LWin down}{m down}
    Send, {LWin up}{m up}
}
; Open the start menu
Action_BottomLeft() {
...
Action_TopRight() {
;    Send, {LWin down}{LShift down}{m down}
;    Send, {LWin up}{LShift up}{m up}
}
